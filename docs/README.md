...
| [project/work-contract.md](project/work-contract.md) | 작업 시작·구현·문서 갱신·완료 보고 계약 |
...
| 문서 | 설명 |
| ---- | ---- |
| [README.md](srpg/README.md) | SRPG 문서 계층·현재 실행 플랜 |
| [SRPG_README.md](srpg/SRPG_README.md) | v2 프로토타입 실행/검증 가이드 |
| [SRPG_프로토타입_마스터플랜.md](srpg/SRPG_프로토타입_마스터플랜.md) | 문서 우선 개편과 코드 2차 착수 준비 기준 |
...
| [SRPG_다음미팅_논의사항.md](srpg/SRPG_다음미팅_논의사항.md) | v1 시절 의사결정 메모 |
...
| [SRPG_IMPLEMENTATION_DECISIONS.md](srpg/SRPG_IMPLEMENTATION_DECISIONS.md) | 구현 브릿지와 다음 의사결정 후보 |
| [SRPG_CHANGELOG.md](srpg/SRPG_CHANGELOG.md) | SRPG 변경 이력 |
...
| [SRPG_NEW_DIALOG_POLICY_LOCK.md](srpg/new/SRPG_NEW_DIALOG_POLICY_LOCK.md) | 신규 대화(06~23) 확정/미정 잠금표 |
